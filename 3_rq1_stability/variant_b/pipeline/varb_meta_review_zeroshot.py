...
def main():
    ...
    output_list = []
    output_filename = f"{ROOT}/analysis_output/VariantB/new/meta/meta_review_zeroshot_test_v2.csv"
    ...
    quan_list = load_jsonl(
        os.path.join(
            rootdir,
            "analysis_output/VariantB/new/quan_zero_shot/results_zero_shot_test41_detailed.jsonl"
        )
    )
