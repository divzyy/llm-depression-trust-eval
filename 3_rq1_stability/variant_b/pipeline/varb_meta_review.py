...
def main():
    ...
    output_list = []
    output_filename = f"{ROOT}/analysis_output/VariantB/new/meta/meta_review_fewshot_test_v2.csv"

    qual_df = pd.read_csv(os.path.join(rootdir, "analysis_output/VariantB/new/qual/qual_assessment_GEMMA_v2.csv"))

    quan_list = load_jsonl(
        os.path.join(
            rootdir,
            "analysis_output/VariantB/new/quan_few_shot/ids_test_chunk_8_step_2_dim_4096_examples_2_embedding_results_analysis_1.jsonl"
        )
    )
