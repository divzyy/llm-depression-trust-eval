#!/bin/bash
#SBATCH --job-name=varB_fewshot_new
#SBATCH --output=logs/rq1_varB_new/job3_fewshot_%j.out
#SBATCH --error=logs/rq1_varB_new/job3_fewshot_%j.err
...
echo "========================================"
echo "RQ1 Variant B — Job 3: Few-shot Quan + Meta (41 subjects)"
...
if [ "$FREE_MEM" -lt "17000" ]; then
    ...
    sbatch $AIPSY_ROOT/slurm/job3_varb_fewshot.sh
    exit 1
fi
...
echo ""
echo "=== Step 1: Few-shot Quantitative Assessment — Variant B ==="
python 3_rq1_stability/variant_b/varb_embedding_batch_script.py \
...
FEWSHOT=$AIPSY_ROOT/analysis_output/VariantB/new/quan_few_shot/ids_test_chunk_8_step_2_dim_4096_examples_2_embedding_results_analysis_1.jsonl
if [ ! -f "$FEWSHOT" ]; then
...
echo ""
echo "=== Step 2: Meta Review — Few-shot (Variant B) ==="
python 3_rq1_stability/variant_b/varb_meta_review.py
echo "Step 2 done: $(date)"

META_OUT=$AIPSY_ROOT/analysis_output/VariantB/new/meta/meta_review_fewshot_test_v2.csv
if [ ! -f "$META_OUT" ]; then
...
echo "Output files:"
echo "  analysis_output/VariantB/new/quan_few_shot/ids_test_chunk_8_step_2_dim_4096_examples_2_embedding_results_analysis_1.jsonl"
echo "  analysis_output/VariantB/new/meta/meta_review_fewshot_test_v2.csv"
echo "========================================"
