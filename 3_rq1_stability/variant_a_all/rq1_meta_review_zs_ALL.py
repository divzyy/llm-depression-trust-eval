...
def main():
    ...
    output_list = []
    output_filename = f"{ROOT}/analysis_output/VariantA/All/meta/meta_review_zs_ALL.csv"

    qual_df = pd.read_csv(f"{ROOT}/analysis_output/VariantA/All/qual/qual_assessment_ALL.csv")

    quan_list = load_jsonl(
        f"{ROOT}/analysis_output/VariantA/All/quan_zero_shot/results_zs_ALL_detailed.jsonl"
    )
