...
def main():
    ...
    output_list = []
    output_filename = f"{ROOT}/analysis_output/VariantA/All/meta/meta_review_fs_ALL.csv"

    qual_df = pd.read_csv(f"{ROOT}/analysis_output/VariantA/All/qual/qual_assessment_ALL.csv")

    quan_list = load_jsonl(
        f"{ROOT}/analysis_output/VariantA/All/quan_few_shot/ids_test_chunk_8_step_2_dim_4096_examples_2_embedding_results_analysis_1.jsonl"
    )
