...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = f"{ROOT}/analysis_output/VariantA/All/quan_few_shot"
    ...
    # RQ1 OVERRIDE — restrict to 13 selected subjects for Variant A ALL
    test_ids = [316, 330, 339, 357, 362, 375, 385, 386, 389, 390, 413, 422, 449]
    log_message(f"RQ1 OVERRIDE: test_ids restricted to {len(test_ids)} subjects for Variant A ALL")
                        ...
                        while retry_count < max_retries and not participant_processed:
                            ...
                            try:
                                with timeout(600):  # 10 minutes of processing, afterwards the attempt is re-tried. Done to handle infinite looping
                                    transcript_path = f"{ROOT}/rq1_perturbations/variant_a/All/{participant_id}_TRANSCRIPT.csv"
