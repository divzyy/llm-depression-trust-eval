...
def main():
    ...
    output_list = []
    output_filename = f"{ROOT}/analysis_output/VariantA/{VARIANT}/meta/meta_review_fs_{VARIANT}.csv"

    qual_df = pd.read_csv(f"{ROOT}/analysis_output/VariantA/{VARIANT}/qual/qual_assessment_{VARIANT}.csv")

    quan_list = load_jsonl(
        f"{ROOT}/analysis_output/VariantA/{VARIANT}/quan_few_shot/ids_test_chunk_8_step_2_dim_4096_examples_2_embedding_results_analysis_1.jsonl"
    )
    ...
    for participant_id in participant_id_list:
        ...
        raw_transcript = _load_transcript(transcript_path)
