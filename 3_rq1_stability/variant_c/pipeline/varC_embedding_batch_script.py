# RQ1 Variant C — Few-shot Quantitative Assessment (embedding_batch_script)
import json
import requests
import pandas as pd
import numpy as np
...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = f"{ROOT}/analysis_output/VariantC/quan_few_shot"
    ...
    if args.eval_split == 'test':
        test_ids = [316, 319, 330, 339, 345, 362, 367, 370, 375, 377, 379, 383,
                    386, 389, 390, 393, 409, 413, 417, 422, 427, 428, 430,
                    436, 441, 445, 447, 449, 451, 455, 456, 459, 468, 472, 484, 485,
                    487, 489]
        log_message(f"NOTE: test_ids overridden with 38 RQ1 VariantC subjects (357, 385, 423 excluded — zero substitutions, identical to original)")
